...
{
    public class DefaultPlayerMoveController : IMoveController
    {
        private IMoveController _wrappedController;
        private Transform _playerTransform;

        public DefaultPlayerMoveController(IMoveController wrappedController, ObjectComponentsModel objectComponentsModel)
        {
